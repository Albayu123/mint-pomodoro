...
const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-12 space-y-8 md:space-y-12 pb-24 md:pb-12">
      <div className="space-y-2">
        <h2 className="text-2xl md:text-3xl font-bold text-white">Application Settings</h2>
        <p className="text-gray-400 text-sm md:text-base">Tailor the focus experience to your specific workflow.</p>
      </div>

      <div className="space-y-6 md:space-y-8 bg-[#1a1a1a] p-6 md:p-8 rounded-3xl border border-gray-800">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between cursor-pointer group py-2 md:py-0">
